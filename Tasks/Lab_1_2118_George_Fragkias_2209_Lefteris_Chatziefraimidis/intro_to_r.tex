...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arbuthnot}\OperatorTok{$}\NormalTok{boys }\OperatorTok{\textgreater{}}\StringTok{ }\NormalTok{arbuthnot}\OperatorTok{$}\NormalTok{girls}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{present\_sum =}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{sample}\NormalTok{(present}\OperatorTok{$}\NormalTok{boys,}\DecValTok{40}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{sample}\NormalTok{(present}\OperatorTok{$}\NormalTok{girls,}\DecValTok{40}\NormalTok{))}
\NormalTok{arbuthnot\_sum =}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{sample}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{boys,}\DecValTok{40}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{sample}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{girls,}\DecValTok{40}\NormalTok{))}

\NormalTok{scale =}\StringTok{ }\NormalTok{present\_sum}\OperatorTok{/}\NormalTok{arbuthnot\_sum}
\KeywordTok{sprintf}\NormalTok{(}\StringTok{"Scale: \%f"}\NormalTok{,scale)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boys\_to\_girl\_ratio\_present =}\StringTok{ }\NormalTok{(present}\OperatorTok{$}\NormalTok{boys)}\OperatorTok{/}\NormalTok{(present}\OperatorTok{$}\NormalTok{girls)}
\KeywordTok{plot}\NormalTok{(present}\OperatorTok{$}\NormalTok{year,boys\_to\_girl\_ratio\_present,}\DataTypeTok{type=}\StringTok{"l"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{intro_to_r_files/figure-latex/boys-to-girl-ratio-comparison-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boys\_to\_girl\_ratio\_arbuthnot =}\StringTok{ }\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{boys)}\OperatorTok{/}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{girls)}
\KeywordTok{plot}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{year,boys\_to\_girl\_ratio\_arbuthnot,}\DataTypeTok{type=}\StringTok{"l"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{intro_to_r_files/figure-latex/boys-to-girl-ratio-comparison-2.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{births\_sum =}\StringTok{ }\NormalTok{(present}\OperatorTok{$}\NormalTok{boys }\OperatorTok{+}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{girls)}
\NormalTok{max\_birth\_index =}\StringTok{ }\KeywordTok{which.max}\NormalTok{(births\_sum)}
\KeywordTok{cat}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"Year with most births(\%d): \%d"}\NormalTok{,births\_sum[max\_birth\_index],present}\OperatorTok{$}\NormalTok{year[max\_birth\_index]))}
\end{Highlighting}
\end{Shaded}
